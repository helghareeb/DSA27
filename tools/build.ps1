...
$lecture07 = Join-Path $Docs 'lectures\07-queues\lecture.md'

Build 'lecture07-handout' $lecture07 `
      (Join-Path $Dist 'DSA27-L07-handout.pdf') ($HandoutOpts + @('--toc', '--toc-depth=2'))
